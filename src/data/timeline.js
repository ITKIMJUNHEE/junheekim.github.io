export const timeline = [
  ...
  {
    date: "2025.12말",
    title: "카카오클라우드 AIaaS 4기 부트캠프 시작",
    detail: "Team 4K로 합류해 최종 프로젝트 Peakly를 진행하게 됩니다.",
  },
  {
    date: "2026.02",
    title: "졸업",
    detail: "부트캠프가 진행 중이던 시점에 졸업했습니다.",
  },
  {
    date: "2026.07초",
    title: "부트캠프 수료 · Peakly 완성",
    detail: "ML(전처리·모델 학습)과 프론트엔드 일부를 담당하며 K3s·ArgoCD GitOps·ML 서빙까지 구축.",
    tag: "Bootcamp",
    status: "healthy",
  },
  {
